...
export class ProductoService {
      ...
      map((data: any[]) => {
        return data.map((prod: any) => {
          return new Producto(
            ...
            prod.stock,
            prod.descripcion,
            prod.categoria || 'Sin categoría' // Valor por defecto si categoria es undefined
          );
        });
      }),
      tap(productos => {
  ...
  agregarProducto(producto: Producto): Observable<Producto> {
    ...
    console.log('Enviando solicitud POST con cuerpo:', productoParaEnviar); // Log para depuración
  ...
  actualizarProducto(updatedProducto: Producto): Observable<Producto> {
    ...
    console.log('Enviando solicitud PUT con cuerpo:', productoParaEnviar); // Log para depuración
